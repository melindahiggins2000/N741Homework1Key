---
title: "Homework 1: Gapminder Example Report - ANSWER KEY"
...
The number of observations in the `gapminder` dataset for life expectancy is `r round(length(gapminder$lifeExp), digits=2)`.
...
#### Plot of Life Expectancy by GDP Per Capita for Americas and Asia for 1992
...
Github Repository for Homework 1 - ANSWER KEY is [https://github.com/melindahiggins2000/N741Homework1Key](https://github.com/melindahiggins2000/N741Homework1Key)
